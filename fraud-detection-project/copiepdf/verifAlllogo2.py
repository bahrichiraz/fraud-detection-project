...
target_location = [315] # Vous pouvez ajuster cela selon vos besoins

# Taille cible des images
target_size = (315, 111)  # Vous pouvez ajuster cela selon vos besoins
...
if len(logo_colors) == 0:
    ...
    red_lower = 128  # Valeur minimale de la composante rouge pour la couleur mauve
    red_upper = 255  # Valeur maximale de la composante rouge pour la couleur mauve

    green_lower = 0  # Valeur minimale de la composante verte pour la couleur mauve
    green_upper = 255  # Valeur maximale de la composante verte pour la couleur mauve

    blue_lower = 128  # Valeur minimale de la composante bleue pour la couleur mauve
    blue_upper = 255  
    ...
    if red_percentage >= 50:  # Vous pouvez ajuster ce seuil selon vos besoins
        print("Le logo est principalement violet.")
    else:
        print("Le logo n'est pas principalement violet.")
